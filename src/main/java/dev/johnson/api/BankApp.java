...
public static BankAccountService bankAccountService = new BankAccountServiceImpl(new BankAccountDaoImpl());
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. Create New Account \n2. Login to view existing account ");
        ...
        switch (input) {
            ...
            case 2:
                    ...
                    System.out.println("Your balance is: $" + b.getBalance()+ " . Your account number is " +  b.getAccountNo());
                    ...
                    switch(input2){
                        ...
                        case 1:
                           ...
                           BankAccount a = bankAccountService.makeDeposit(b,val);
                            System.out.println("Your balance is now: " + a.getBalance() + " Thanks for your money.");
                            break;
                        case 2:
